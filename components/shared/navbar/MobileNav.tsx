        ...
        <Sheet>
            ...
            <SheetContent side="left" className='background-light900_dark200 border-none' >
                <Link href='/' className='flex items-center gap-1'>
                    <Image src="/assets/images/site-logo.svg" width={23} height={23} alt='devOvereflow' />
                        ...
                        <div className='flex flex-col gap-3'>
                            ...
                            <SheetClose asChild>
                                <Link href='/sign-up'>
                                    ...
                                    btn-tertiary min-h-[41px] w-full rounded-lg px-4 py-3 shadow-none text-dark400_light900'>
